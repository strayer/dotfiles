-- Downloaded from: https://github.com/kvndrsslr/sketchybar-app-font/releases/download/v2.0.48/icon_map.lua
-- To update, download the latest release and replace this file.
return {
	["Live"] = ":ableton:",
	["Acrobat"] = ":acrobat:",
